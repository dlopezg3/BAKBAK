...
ActiveRecord::Schema[7.1].define(version: 2024_02_13_112358) do
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_size_id"], name: "index_recipes_on_product_size_id"
  end
  ...
  add_foreign_key "recipes", "product_sizes"
end
